...
<table width="100%"  >
  <tr align=right>
    <td colspan="2"><img src="policecrime.jpg" width="770" height="60"><BR>
	<%@ include file="header3.htm" %>
		</td>
  </tr>
  <tr>
    <td width="20%">
    ...
    <td width="80%" background="PoliceCrimeBkng.jpg" ><BR><CENTER><p><FONT SIZE="5" face="century gothic" COLOR="#800000"><B>Welcome!</B></FONT><p><font size="4" face="Verdana" color="#003399"><B>Dear Writer</B> </font></p></CENTER>
