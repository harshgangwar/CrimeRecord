...
<body bgcolor=aliceblue leftmargin=0 topmargin=0>
 <form method="POST" action="crime_category_nature_searchresult1.jsp">
   ...
   <td colspan=4 width="360" height="70">
    <p align="center"><b><font face="Verdana" size="4"> Crime Category Nature Master
  </font></b>
  ...
  <tr>
     <td width="25%" align="right"><b>
	         ...
	         Crime	Category NatureType ID</font>
        </b></td>
