...
function func_sub()
{
      ...
      cse_form.action="crime_seq_insert.jsp";
...
{
     cse_form.action="crime_seq_search.jsp";
     cse_formmethod="post";
     cse_form.submit();
}
function func_delete()
{
     cse_form.action="crime_seq_delete.jsp";
     cse_form.method="post";
     cse_form.submit();
}
</script>
...
<body bgcolor=aliceblue leftmargin=0 topmargin=0>
   ...
   <td colspan=4 width="360" height="70">
    <p align="center"><font color="#996633" size="4"></font><font size="5">Crime Sequence Estimation Master</font></p>
  <p align="center">&nbsp;</p>
  </td>
  </tr>
  <tr>
