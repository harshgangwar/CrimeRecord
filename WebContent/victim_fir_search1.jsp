...
<head>
 ...
 <form method="POST" action="victim_fir_searchresult1.jsp">
   ...
   <td colspan=4 width="360" height="70">
    <p align="center"><b><font face="Verdana" size="4">Victim FIR
   </font></b>
  <p align="center">
  <br>
 ...
 try{
	...
	rs=st.executeQuery("select FIR_NO from VICTIMS_FIR_MASTER");
	while(rs.next())
	 {
		c1=rs.getString(1);
		%>
