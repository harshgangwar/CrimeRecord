...
<body bgcolor=aliceblue>
 ...
 try{
	...
	rs=st.executeQuery("select * from department_master where department_no='"+b+"'");
	while(rs.next())
	 {
		c1=rs.getString(1);
        c2=rs.getString(2);
...
%>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Department Name:</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c2%>
	  </font>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Highest Designation ID :</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c4%>
	  </font>
