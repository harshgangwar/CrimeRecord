...
<table border="0" width="80%">
 ...
 try{
	...
	rs=st.executeQuery("select * from EVIDENCE_TYPE_MASTER where evidence_type_master='"+request.getParameter("a")+"'");
	while(rs.next())
	 {
		c1=rs.getString(1);
        c2=rs.getString(2);
...
%>
    <table width="436">
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Evidence Type ID:</font> </b></td>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Evidence Type Name:</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c2%>
	  </font>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Evidence Type Desc:</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c3%>
	  </font>
