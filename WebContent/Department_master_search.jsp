...
<body bgcolor=aliceblue leftmargin=0 topmargin=0>
 <form method="POST" action="Department_master_searchresult.jsp">
   ...
   <td colspan=4 width="360" height="70">
    <p align="center"><b><font face="Verdana" size="4"> Department Master
  </font></b>
  <p align="center">
  <br>
 ...
 try{
	...
	rs=st.executeQuery("select * from DEPARTMENT_MASTER");
	while(rs.next())
	 {
		c1=rs.getString(1);
		%>
