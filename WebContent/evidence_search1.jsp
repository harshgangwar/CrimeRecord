...
<body bgcolor=aliceblue leftmargin=0 topmargin=0>
 <form method="POST" action="evidence_searchresult1.jsp">
   ...
   <td colspan=4 width="360" height="70">
    <p align="center"><b><font face="Verdana" size="4">Evidence Master   </font></b>
 ...
 try{
	...
	rs=st.executeQuery("select * from EVIDENCE_MASTER ");
	while(rs.next())
	 {
		c1=rs.getString(1);
		%>
