...
<body bgcolor=aliceblue>
 <table border="0" width="80%">
   ...
   <td colspan=4 width="360" height="70">
    <p align="center"><b><font face="Verdana" size="4">Crime Category Report
   </font></b>
 ...
 try{
	...
	rs=st.executeQuery("select * from CRIME_CATEGORY_MASTER where crime_category_id='"+request.getParameter("a")+"'");
	while(rs.next())
	 {
		c1=rs.getString(1);
        c2=rs.getString(2);
...
%>
    <table width="436">
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Crime Category Type ID:</font> </b></td>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Crime Category Desc:</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c3%>
	  </font>
