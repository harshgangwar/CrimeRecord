...
Evidence Report   </font></b>
 ...
 try{
	...
	rs=st.executeQuery("select * from EVIDENCE_MASTER where EVIDENCE_ID='"+b+"'");
	while(rs.next())
	 {
	   c1=rs.getString(1);
       c2=rs.getString(2);
...
%>
    <table width="477">
	<tr>
     <td width="296" align="right" height="25"><b><font size="3">Evidence ID:</font>
       </b></td>
      <td width="167" align="left"><b>
	...
	<tr>
     <td width="296" align="right" height="25"><b> <font size="3"> Investigation ID:</font> </b></td>
      <td width="167" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c2%>
	  </font>
       ...
       <tr>
     <td width="296" align="right" height="25"><b> <font size="3"> Evidence Type ID:
      ID:</font> </b></td>
      <td width="167" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c3%>
	...
	<tr>
     <td width="296" align="right" height="25"><b><font size="3">Collected Date:</font> </b></td>
      <td width="167" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c4%>
	  </font>
