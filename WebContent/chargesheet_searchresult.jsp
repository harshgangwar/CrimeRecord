...
<body bgcolor=aliceblue>
 <form method="POST" action="search_client_result.jsp">
...
Crime Charge Sheet Master   </font></b>
 ...
 try{
	...
	rs=st.executeQuery("select * from CRIME_CHARGESHEET_MASTER where CHARGE_SHEET_NO='"+s+"'");
	while(rs.next())
	 {
		c1=rs.getString(1);
        c2=rs.getString(2);
...
%>
    <table width="436">
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Crime Charge Sheet No:</font> </b></td>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Charge Sheet Date:</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c2%>
	  </font>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Charge Sheet Details:</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c3%>
	  </font>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Produced Court Name:</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c5%>
	  </font>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Charge Sheet Field By</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c6%>
	  </font>
