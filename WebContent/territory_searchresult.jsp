...
<table border="0" width="80%">
   ...
   <td colspan=4 width="360" height="70">
    <p align="center"><b><font face="Verdana" size="4"><b>Evidence Type
   </font></b>
  <p align="center">
  <br>
 ...
 try{
	...
	rs=st.executeQuery("select * from TERRITORY_MASTER where territory_id='"+request.getParameter("a")+"'");
	while(rs.next())
	 {
		c1=rs.getString(1);
        c2=rs.getString(2);
...
%>
    <table width="436">
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Territory ID:</font> </b></td>
	...
	<tr>
     <td width="302" align="right" height="25"><b><font size="3">Territory Name:</font> </b></td>
      <td width="120" align="left"><b>
      <font face="Verdana" size="2">
	  <%=c2%>
	  </font>
