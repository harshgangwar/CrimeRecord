...
<form method="POST" action="territory_searchresult.jsp">
  <table border="0" width="80%">
   ...
   <td colspan=4 width="360" height="70">
    <p align="center"><b><font face="Verdana" size="4">Territory Master
   </font></b>
  <p align="center">
  <br>
 ...
 try{
	...
	rs=st.executeQuery("select * from TERRITORY_MASTER");
	while(rs.next())
	 {
		c1=rs.getString(1);
		%>
